...
[Getting started](https://www.elastic.co/guide/en/beats/winlogbeat/7.1/winlogbeat-getting-started.html) guide.

## Documentation

Visit [Elastic.co Docs](https://www.elastic.co/guide/en/beats/winlogbeat/7.1/index.html)
